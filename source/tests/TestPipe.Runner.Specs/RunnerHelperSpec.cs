namespace TestPipe.Runner.Specs
{
    ...
    public class RunnerHelperSpec
    {
        ...
        [TestClass]
        public class SetTestSessionDefaultBrowser
        {
            [TestMethod]
            public void SetTestSessionDefaultBrowser_Should_Not_Set_Default_Browser()
            {
                var expected = BrowserTypeEnum.Chrome;
                TestSession.Cache.Clear();

                TestSession.DefaultBrowser = expected;
                ...
                var actual = TestSession.DefaultBrowser;

                Assert.AreEqual(expected, actual);
            }

            [TestMethod]
            public void SetTestSessionDefaultBrowser_Should_Set_Default_Browser()
            {
                var expected = BrowserTypeEnum.FireFox;
                TestSession.Cache.Clear();
                TestPipe.Core.Session.SessionSuite suite = new TestPipe.Core.Session.SessionSuite();
                TestSession.Suite = suite;
                TestSession.Suite.Browser = "FireFox";
